...
const ConversationPagePatient = () => {
    ...
    const handleGetConversation = async () => {
        try {
            ...
            const response = await axios.post('/api/medicine/getConversationPatient', {
    ...
    const handleSendMessage = async () => {
        try {
            ...
            await axios.post('/api/medicine/sendMessagesPatient', {
...
export default ConversationPagePatient;
